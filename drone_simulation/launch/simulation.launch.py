...
def generate_launch_description():
    ...
    simulator_yaml_arg = DeclareLaunchArgument(
        'simulator_yaml', 
        default_value=os.path.join(get_package_share_directory('drone_simulation'), 'config', 'config.yaml'),
        description='The configurations for the simulator to run')
